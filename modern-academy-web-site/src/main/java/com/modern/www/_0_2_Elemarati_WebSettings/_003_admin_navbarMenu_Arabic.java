 ...
 * @author Mahmoud
 */
public class _003_admin_navbarMenu_Arabic {
    ...
    public synchronized String getMainTabs(String tabs_type, String lang) {
        ...
        for (A0001MainTabs a0001MainTabs : A0001MainTabsList) {
            ...
            navbar += "<li>\n"
                    ...
                    + "        <span class=\"ttr-label\">" + a0001MainTabs.getMainTabNameA()+ "</span>\n";
            navbar += arrow;
            navbar += "    </a>\n";
    ...
    private synchronized String getTabs(A0001MainTabs a0001MainTabs, String lang) {
        ...
        for (A0002Tabs a0002Tabs : A0002TabsList) {
            ...
            navbar += "    <li>\n"
                    + "        <a href=\"" + a0002Tabs_link + "\" class=\"ttr-material-button\"><span class=\"ttr-label\">" + a0002Tabs.getTabNameA()+ "</span></a>\n"
                    + "    </li>\n";
        }
        navbar += (A0002TabsList.isEmpty()) ? "" : "</ul>";
        return navbar;
