 ...
 * @author Mahmoud
 */
public class _011_tree_navbarMenu_English {
    ...
    public synchronized String getMainTabs(String tabs_type) {
        ...
        for (A0001MainTabs a0001MainTabs : A0001MainTabsList) {
            ...
            if (a0001MainTabs.getA0002Tabses().isEmpty()) {
                navbar += "<li>" + a0001MainTabs.getMainTabNameE() + link + "</li>";
            } else {

                navbar += "<li><span class=\"caret\">" + a0001MainTabs.getMainTabNameE() + link + "</span><ul class=\"nested\">";
                /**
                 * Get All Tabs
                 */
                ...
                for (A0002Tabs a0002Tabs : A0002TabsList) {
                    ...
                    if (a0002Tabs.getA0003SubTabses().isEmpty()) {
                        navbar += "<li>" + a0002Tabs.getTabNameE() + link + "</li>";
                    } else {

                        navbar += "<li><span class=\"caret\">" + a0002Tabs.getTabNameE() + link + "</span><ul class=\"nested\">";;
                        ...
                        for (A0003SubTabs a0003SubTabs : A0003SubTabsList) {
                            ...
                            navbar += "<li>" + a0003SubTabs.getSubTabNameE() + link + "</li>";
                        }
