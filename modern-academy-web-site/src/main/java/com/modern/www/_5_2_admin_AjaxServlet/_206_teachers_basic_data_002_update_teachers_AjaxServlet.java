 ...
 * @author cdc
 */
public class _206_teachers_basic_data_002_update_teachers_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String teacherId = a_0_9_9_9_teachers.getTeacher_id();
            ...
            List<A0999Teachers> tlist = new A0999Teachers_DAO<>().GetTeacherByiD(teacherId);
            if (tlist.isEmpty()) {
                throw new Exception();
            }

            A0999Teachers a0999Teachers = tlist.get(0);
            a0999Teachers.setTeacherNameA(teacher_name_a);
            a0999Teachers.setTeacherNameE(teacher_name_e);
            a0999Teachers.setTeacherAcademicEmail(teacher_academic_email);
            a0999Teachers.setTeacherPassword(new Encryption().enchrypt(teacher_password));
            a0999Teachers.setA0998TeachersTypes(a0998TeachersTypes);
            a0999Teachers.setA0996Departments(a0996Departments);
