 ...
 * @author cdc
 */
public class _998_teacher_profile_004_change_teacher_password_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<A0999Teachers> A0999TeachersList = new A0999Teachers_DAO<>().GetTeacherBy(teacher_academic_email, decripted_password);
            ...
            a0999Teachers.setTeacherPassword(decripted_new_password);
