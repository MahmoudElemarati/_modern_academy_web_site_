 ...
 * @author Mahmoud
 */
public class _002_site_login_ControlServlet extends HttpServlet {
            ...
            if (A0052StudentsList.isEmpty()) {
                ...
                if (A0999TeachersList.isEmpty()) {
                    ...
                    if (A9999AdminUsersList.isEmpty()) {
                        response.sendRedirect("_001_site_login_AccessServlet?lang=" + lang);
                    } else {
                        A9999AdminUsers a9999AdminUsers = A9999AdminUsersList.get(0);
                        request.getSession().setAttribute("a9999AdminUsers", a9999AdminUsers);
                        request.getSession().setAttribute("a0999Teachers", null);
                        request.getSession().setAttribute("a0052Students", null);
                        response.sendRedirect("_100_account_index_AccessServlet?lang=" + lang);
                    }
                } else {
                    A0999Teachers a0999Teachers = A0999TeachersList.get(0);
                    request.getSession().setAttribute("a9999AdminUsers", null);
