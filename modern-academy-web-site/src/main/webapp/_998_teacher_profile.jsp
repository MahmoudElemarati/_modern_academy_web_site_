...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            %>
            setTeacherId('<%=lang%>', '<%=user_name_or_academic_email%>');
            <%
            } else {
            %>
            getTeacherId('<%=lang%>');
                        ...
                        <div class="profile-bx text-center" id="user_main_card">
                            ...
                            <div class="profile-social">
                                <ul class="list-inline m-a0">
                                    <li><a id="facebook_div" href="#"><i class="fa fa-facebook"></i></a></li>
                                    <li><a id="twitter_div" href="#"><i class="fa fa-twitter"></i></a></li>
                                    <li><a id="linkedin_div" href="#"><i class="fa fa-linkedin"></i></a></li>
                                    <li><a id="google_plus_div" href="#"><i class="fa fa-google-plus"></i></a></li>
                                </ul>
                            </div>
                                    ...
                                    <div class="edit-profile">
                                        <div class="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                    <input class="form-control" id="teacher_name_a" type="text" placeholder="<%=(lang.equals("ar")) ? "الإسم باللغة العربية" : "Name In Arabic"%>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                    <input class="form-control" id="teacher_name_e" type="text" placeholder="<%=(lang.equals("ar")) ? "الإسم باللغة الإنجليزية" : "Name In English"%>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                    <input class="form-control" readonly="" id="teacher_academic_email" type="text" placeholder="<%=(lang.equals("ar")) ? "الإيميل الأكاديمي" : "Academic Email"%>">
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label"><%=(lang.equals("ar")) ? "الدرجة العلمية" : "Degree"%></label>
                                                <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                    <input class="form-control" readonly="" id="teacher_type" type="text" placeholder="<%=(lang.equals("ar")) ? "الدرجة العلمية" : "Degree"%>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-12 col-sm-9 col-md-9 col-lg-10 ml-auto">
                                                    <h3 class="m-form__section"><%=(lang.equals("ar")) ? "3. روابط اجتماعية" : "3. Social Links"%></h3>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                    <input class="form-control" type="text" id="teacher_linked_in" placeholder="Linkedin">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Facebook</label>
                                                <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                    <input class="form-control" type="text" id="teacher_facebook" placeholder="Facebook">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Twitter</label>
                                                <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                    <input class="form-control" type="text" id="teacher_twitter" placeholder="Twitter">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Google-Plus</label>
                                                <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                    <input class="form-control" type="text" id="teacher_google_plus" placeholder="Google-Plus">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="">
                                            <div class="">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                        <button id="saveProfile" class="btn" onclick="update_teacher_profile();">Save changes</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="">
                                            <div class="">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                        <button class="btn" onclick="update_teacher_profile();">Save changes</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="change-password">
                                    ...
                                    <div class="edit-profile">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-8 col-md-8 col-lg-7">
                                                <button onclick="change_teacher_password();" class="btn">Save changes</button>
                                            </div>
                                        </div>
