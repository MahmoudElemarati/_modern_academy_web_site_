...
<html lang="en">
    ...
    <body class="ttr-opened-sidebar ttr-pinned-sidebar">
                        ...
                        <div class="widget-box" style="height: auto;">
                            ...
                            <div class="widget-inner"> 
                                <div class="row"> 
                                    ...
                                    <div class="col-12">
                                        <br>
                                        <button type="button" onclick="add_tabs('account', '<%=lang%>');" class="btn" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-plus-circle"></i> <%=(lang.equals("ar")) ? "حفظ" : "Save"%></button>
                                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1000px;" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" onclick="update_main_tabs('', '', '', '', '', '', 'account', 'update-modal', '<%=lang%>')" class="btn" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-edit"></i> <%=(lang.equals("ar")) ? "تعديل" : "Update"%></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal right fade  bd-example-modal-lg" id="mainTabsDeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1000px;" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn-secondry add-item m-r5 radius-xl" data-dismiss="modal"><i class="fa fa-fw fa-close"></i> <%=(lang.equals("ar")) ? "إلغاء" : "Cancel"%></button>
                        <button type="button" onclick="delete_main_Tabs('', 'account', 'delete-modal', '<%=lang%>')" class="btn-danger" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-close"></i> <%=(lang.equals("ar")) ? "حذف" : "Delete"%></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal right fade  bd-example-modal-lg" id="TabsUpdateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1000px;" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn-secondry add-item m-r5 radius-xl" data-dismiss="modal"><i class="fa fa-fw fa-close"></i> <%=(lang.equals("ar")) ? "إلغاء" : "Cancel"%></button>
                        <button type="button" onclick="update_tabs('', '', '', '', '', '', '', '', 'account', 'update-modal', '<%=lang%>')" class="btn" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-edit"></i> <%=(lang.equals("ar")) ? "تعديل" : "Update"%></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal right fade  bd-example-modal-lg" id="TabsDeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1000px;" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn-secondry add-item m-r5 radius-xl" data-dismiss="modal"><i class="fa fa-fw fa-close"></i> <%=(lang.equals("ar")) ? "إلغاء" : "Cancel"%></button>
                        <button type="button" onclick="delete_Tabs('', '', 'account', 'delete-modal', '<%=lang%>')" class="btn-danger" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-close"></i> <%=(lang.equals("ar")) ? "حذف" : "Delete"%></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
                            init('account', '<%=lang%>', '_201_admin_student_pages');
        </script>
