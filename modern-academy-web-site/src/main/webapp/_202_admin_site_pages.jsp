...
<html lang="en">
    ...
    <body class="ttr-opened-sidebar ttr-pinned-sidebar">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 m-b30">
                        ...
                        <div class="widget-box" style="height: auto;">
                            ...
                            <div class="widget-inner"> 
                                <div class="row"> 
                                    ...
                                    <div class="col-12">
                                        <br>
                                        <button type="button" onclick="add_main_tabs('site', '<%=lang%>');" class="btn" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-plus-circle"></i> <%=(lang.equals("ar")) ? "حفظ" : "Save"%></button>
                                    </div>
                        ...
                        <div class="widget-box" style="height: auto;">
                            ...
                            <div class="widget-inner"> 
                                <div class="row"> 
                                    ...
                                    <div class="col-12">
                                        <br>
                                        <button type="button" onclick="add_tabs('site', '<%=lang%>');" class="btn" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-plus-circle"></i> <%=(lang.equals("ar")) ? "حفظ" : "Save"%></button>
                                    </div>
                        ...
                        <div class="widget-box" style="height: auto;">
                            <div class="wc-title">
                                <h4><%=(lang.equals("ar")) ? "القوائم الفرعية" : "Sub Tabs"%></h4>
                            </div>
                            <div class="widget-inner"> 
                                <div class="row"> 
                                    <div class="col-md-6">
                                        <label class="col-form-label"><%=(lang.equals("ar")) ? "القائمة الرئيسية" : "Main Tab"%></label>
                                        <div style="display: flex;">
                                            <select class="form-control" id="mainTabId-subTab" onchange="get_tabs_by_main_tab('site', '<%=lang%>', 'combo', 'tabId-subTab')" type="text" value="">                                                

                                            </select>                                            
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="col-form-label"><%=(lang.equals("ar")) ? "القائمة" : "Tab"%></label>
                                        <div style="display: flex;">
                                            <select class="form-control" id="tabId-subTab" type="text" value="">                                                

                                            </select>                                            
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="col-form-label"><%=(lang.equals("ar")) ? "إسم القائمة الفرعبة باللغة الإنجليزية" : "Sub Tab Name In English"%></label>
                                        <div>
                                            <input class="form-control" id="subTabNameE" type="text" placeholder="<%=(lang.equals("ar")) ? "إسم القائمة الفرعبة باللغة الإنجليزية" : "Sub Tab Name In English"%>" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="col-form-label"><%=(lang.equals("ar")) ? "إسم القائمة باللغة العربية" : "Tab Name In Arabic"%></label>
                                        <div>
                                            <input class="form-control" id="subTabNameA" type="text" placeholder="<%=(lang.equals("ar")) ? "إسم القائمة الفرعبة باللغة العربية" : "Sub Tab Name In Arabic"%>" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="col-form-label"><%=(lang.equals("ar")) ? "الأيقونة" : "Icon"%></label>
                                        <div style="display: flex;">
                                            <select class="form-control" onchange='changeIcon("addForm_subtab", "iconFaFa-2-subTab");' id="iconFaFa-2-subTab" type="text" placeholder="<%=(lang.equals("ar")) ? "الأيقونة" : "Icon"%>" value="">                                                
                                                <option value='ti-home' class='ti-home'>ti-home</option>
                                                <option value='ti-book' class='ti-book'>ti-book</option>
                                                <option value='ti-email' class='ti-email'>ti-email</option>
                                                <option value='ti-calendar' class='ti-calendar'>ti-calendar</option>
                                            ...
                                            <i class="icon ti-home" id="addForm_subtab"></i>
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <label class="col-form-label"><%=(lang.equals("ar")) ? "الرابط" : "Link"%></label>
                                        <div>
                                            <input class="form-control" id="link-subTab" type="text" placeholder="<%=(lang.equals("ar")) ? "الرابط" : "Link"%>" value="">
                                        </div>
                                    </div>

                                    <div class="col-12">
                                        <br>
                                        <button type="button" onclick="add_sub_tabs('site', '<%=lang%>');" class="btn" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-plus-circle"></i> <%=(lang.equals("ar")) ? "حفظ" : "Save"%></button>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="table-responsive">
                                            <table id="subTabTable" class="table table-sm table-striped table-bordered table-hover" style="text-align: center;" >
                                                <thead class="thead-dark">
                                                    <tr>
                                                        <th>
                                                            <%=(lang.equals("ar")) ? "إسم القائمة الفرعبة باللغة الإنجليزية" : "Tab Name In English"%>
                                                        </th>
                                                        <th>
                                                            <%=(lang.equals("ar")) ? "إسم القائمة الفرعبة باللغة العربية" : "Tab Name In Arabic"%>
                                                        </th>
                                                        <th>
                                                            <%=(lang.equals("ar")) ? "الأيقونة" : "Icon"%>
                                                        </th>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1000px;" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" onclick="update_main_tabs('', '', '', '', '', '', 'site', 'update-modal', '<%=lang%>')" class="btn" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-edit"></i> <%=(lang.equals("ar")) ? "تعديل" : "Update"%></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal right fade  bd-example-modal-lg" id="mainTabsDeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1000px;" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn-secondry add-item m-r5 radius-xl" data-dismiss="modal"><i class="fa fa-fw fa-close"></i> <%=(lang.equals("ar")) ? "إلغاء" : "Cancel"%></button>
                        <button type="button" onclick="delete_main_Tabs('', 'site', 'delete-modal', '<%=lang%>')" class="btn-danger" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-close"></i> <%=(lang.equals("ar")) ? "حذف" : "Delete"%></button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <label class="col-form-label"><%=(lang.equals("ar")) ? "الشاشة تتبع قسم" : "Screen Relate To Department"%></label>
                                <div style="display: flex;">
                                    <select class="form-control"  id="department_id" type="text" value="">     
                                        <option value=''><%=(lang.equals("ar")) ? "اختر قسم" : "Choose Department"%></option>
                                        <%
                                            List<A0996Departments> dList = new A0996Departments_DAO().GetAllDepartments();
                                            for (A0996Departments d : dList) {
                                        %>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn-secondry add-item m-r5 radius-xl" data-dismiss="modal"><i class="fa fa-fw fa-close"></i> <%=(lang.equals("ar")) ? "إلغاء" : "Cancel"%></button>
                        <button type="button" onclick="update_tabs('', '', '', '', '', '', '', '', 'site', 'update-modal', '<%=lang%>')" class="btn" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-edit"></i> <%=(lang.equals("ar")) ? "تعديل" : "Update"%></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal right fade  bd-example-modal-lg" id="TabsDeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1000px;" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn-secondry add-item m-r5 radius-xl" data-dismiss="modal"><i class="fa fa-fw fa-close"></i> <%=(lang.equals("ar")) ? "إلغاء" : "Cancel"%></button>
                        <button type="button" onclick="delete_Tabs('', '', 'site', 'delete-modal', '<%=lang%>')" class="btn-danger" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-close"></i> <%=(lang.equals("ar")) ? "حذف" : "Delete"%></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal right fade  bd-example-modal-lg" id="SubTabsUpdateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1000px;" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"><%=(lang.equals("ar")) ? "تعديل القائمة الفرعية" : "Update Sub Tab"%></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="row">                             
                            <div class="col-md-6">
                                <label class="col-form-label"><%=(lang.equals("ar")) ? "إسم القائمة الفرعبة باللغة الإنجليزية" : "Sub Tab Name In English"%></label>
                                <div>
                                    <input class="form-control" id="subTabNameE-update" type="text" placeholder="<%=(lang.equals("ar")) ? "إسم القائمة الفرعبة باللغة الإنجليزية" : "Sub Tab Name In English"%>" value="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="col-form-label"><%=(lang.equals("ar")) ? "إسم القائمة باللغة العربية" : "Tab Name In Arabic"%></label>
                                <div>
                                    <input class="form-control" id="subTabNameA-update" type="text" placeholder="<%=(lang.equals("ar")) ? "إسم القائمة الفرعبة باللغة العربية" : "Sub Tab Name In Arabic"%>" value="">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <label class="col-form-label"><%=(lang.equals("ar")) ? "الأيقونة" : "Icon"%></label>
                                <div style="display: flex;">
                                    <select class="form-control" onchange='changeIcon("addForm_subtab-update", "iconFaFa-2-subTab-update");' id="iconFaFa-2-subTab-update" type="text" placeholder="<%=(lang.equals("ar")) ? "الأيقونة" : "Icon"%>" value="">                                                
                                        <option value='ti-home' class='ti-home'>ti-home</option>
                                        <option value='ti-book' class='ti-book'>ti-book</option>
                                        <option value='ti-email' class='ti-email'>ti-email</option>
                                        <option value='ti-calendar' class='ti-calendar'>ti-calendar</option>
                                    ...
                                    <i class="icon ti-home" id="addForm_subtab-update"></i>
                                </div>
                            </div>
                            <div class="col-md-9">
                                <label class="col-form-label"><%=(lang.equals("ar")) ? "الرابط" : "Link"%></label>
                                <div>
                                    <input class="form-control" id="link-subTab-update" type="text" placeholder="<%=(lang.equals("ar")) ? "الرابط" : "Link"%>" value="">
                                </div>
                            </div>  
                            <div class="col-md-3">
                                <label class="col-form-label"><%=(lang.equals("ar")) ? "الترتيب" : "index"%></label>
                                <div>
                                    <input class="form-control" id="index-sub_tab-update" type="text" placeholder="<%=(lang.equals("ar")) ? "الترتيب" : "index"%>" value="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn-secondry add-item m-r5 radius-xl" data-dismiss="modal"><i class="fa fa-fw fa-close"></i> <%=(lang.equals("ar")) ? "إلغاء" : "Cancel"%></button>
                        <button type="button" onclick="update_sub_tabs('', '', '', '', '', '', '', '', 'site', 'update-modal', '<%=lang%>')" class="btn" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-edit"></i> <%=(lang.equals("ar")) ? "تعديل" : "Update"%></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Modal -->
        <div class="modal right fade  bd-example-modal-lg" id="SubTabsDeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1000px;" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"><%=(lang.equals("ar")) ? "حذف القائمة الفرعية" : "Delete Sub Tab"%></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn-secondry add-item m-r5 radius-xl" data-dismiss="modal"><i class="fa fa-fw fa-close"></i> <%=(lang.equals("ar")) ? "إلغاء" : "Cancel"%></button>
                        <button type="button" onclick="delete_sub_Tabs('', '', '', 'site', 'delete-modal', '<%=lang%>')" class="btn-danger" style="-webkit-border-radius: 100px;"><i class="fa fa-fw fa-close"></i> <%=(lang.equals("ar")) ? "حذف" : "Delete"%></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
                            init('site', '<%=lang%>', '_202_admin_site_pages');
        </script>
